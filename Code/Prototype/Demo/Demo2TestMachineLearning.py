...
x = 0
imagex = 0
visualiseMachineLearning("../MainBuild/FileMethods/TrainingData/training_dataTemp.arff",
                         "../MainBuild/FileMethods/TrainingData/query.arff",x, training_list[x].image_list[imagex], training_list)
visualiseMachineLearning("../MainBuild/FileMethods/TrainingData/training_dataTemp.arff",
                         "../MainBuild/FileMethods/TrainingData/query.arff",1, training_list[1].image_list[imagex], training_list)
visualiseMachineLearning("../MainBuild/FileMethods/TrainingData/training_dataTemp.arff",
                         "../MainBuild/FileMethods/TrainingData/query.arff",4, training_list[4].image_list[imagex], training_list)