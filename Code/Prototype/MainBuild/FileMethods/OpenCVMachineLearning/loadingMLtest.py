...
Code to test if loading the machine learning model would work using openCV.
Test code before creating the JeVois Module code

used for testing classification time as well.
"""
...
from Code.Prototype.MainBuild.FileMethods.OpenCVMachineLearning.GenerateMLmodel import loadValues

query_data, query_labels = loadValues('TrainingData/query_dataTemp.arff')

#print(query_data)
tic = time.perf_counter()
ML_model = cv2.ml.RTrees_load("MLmodels/random_trees_model.xml")
